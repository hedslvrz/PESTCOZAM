...
(46, 'testing', '', 'testing', 'testing@gmail.com', '09831341345', '$2y$10$Dyy9BcO6tW3dF..9yTZAV.ZKgsfYVDDDBwdR7oJCD4F1VHkcwD2a6', '2025-04-13 13:44:08', 'supervisor', 'active', NULL, NULL, NULL, NULL, NULL),
...
CREATE TABLE `followup_visits` (
  ...
  CONSTRAINT `followup_visits_ibfk_1` FOREIGN KEY (`plan_id`) REFERENCES `followup_plan` (`id`) ON DELETE CASCADE,
  CONSTRAINT `followup_visits_ibfk_2` FOREIGN KEY (`appointment_id`) REFERENCES `appointments` (`id`) ON DELETE CASCADE,
  CONSTRAINT `followup_visits_ibfk_3` FOREIGN KEY (`technician_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
